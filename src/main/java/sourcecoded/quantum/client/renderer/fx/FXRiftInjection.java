...
public class FXRiftInjection extends EntityFX {
    ...
    public static class DataHolder {
        ...
        public float xRad = 0.25F;
        public float yRad = 0.5F;
        public float zRad = 0.25F;
    ...
    public FXRiftInjection(World world, double x, double y, double z, DataHolder data) {
        super(world, x, y, z);
        this.data = data;
