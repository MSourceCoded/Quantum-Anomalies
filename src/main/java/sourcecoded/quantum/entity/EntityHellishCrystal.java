...
public class EntityHellishCrystal extends Entity {
    ...
    public EntityHellishCrystal(World p_i1698_1_) {
        super(p_i1698_1_);
    ...
    public EntityHellishCrystal(World p_i1699_1_, double p_i1699_2_, double p_i1699_4_, double p_i1699_6_) {
        this(p_i1699_1_);
            ...
            if (!this.isDead && !this.worldObj.isRemote) {
                ...
                if (this.health <= 0) {
                    ...
                    if (!this.worldObj.isRemote) {
                        ...
                        this.worldObj.setBlock((int)this.posX, (int)this.posY, (int)this.posZ, BlockRegistry.instance().getBlockByName("blockChaosHell"));
                        ...
                        SphereUtils.generate((int) this.posX, (int) this.posY + 6, (int) this.posZ, 3, callback);
